...
const rows = [
    createData('lecture Slide - Session 1', new Date().toISOString()),
    createData('lecture Slide - Session 2', new Date().toISOString()),
    createData('lecture Slide - Session 3', new Date().toISOString()),
    createData('lecture Slide - Session 4', new Date().toISOString()),
    createData('lecture Slide - Session 5', new Date().toISOString()),
    createData('lecture Slide - Session 6', new Date().toISOString()),
];
            ...
            <Container maxWidth="md">
                <Card align="center" className={classes.paddingSumission}>
                    ...
                    <Typography color="textSecondary" variant="subtitle1" display="inline">
                                Drag and Drop Your File to Upload Course Material
                    </Typography>
                    <CloudUploadIcon color="disabled" />
                </Card>
            </Container>
